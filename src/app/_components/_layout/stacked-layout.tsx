 ...
 * @returns 
 */
export default function SiteStackedLayout({ children, headtitle, headCurrent }: SiteStackedLayoutProps) {
            ...
            {headtitle &&
                <header className="bg-white shadow">
                    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                        <h1 className="text-3xl font-bold tracking-tight text-gray-900">{headtitle}</h1>
                    </div>
                </header>
            }
            <main>
