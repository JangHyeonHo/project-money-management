...
import { HouseholdRegistProps, HouseholdRegModActionProps } from "../_types/household-type";
import { InputDropdownPropsItem } from "@/app/_types/common-types";
import InputDatePicker from "@/app/_components/_input/input-datepicker";
                    ...
                    <div className="sm:col-span-4">
                        <label className="form-control w-full max-w-md">
                            ...
                            <InputDropdown
                                ...
                                name="assetKey"
                                disabled={loading}
                                defaultBtnName={w('common.select')}
                    ...
                    <div className="sm:col-span-4">
                        <label className="form-control w-full max-w-md">
                            ...
                            <InputDropdown
                                ...
                                name="householdType"
                                disabled={loading}
                                defaultBtnName={w('household.income')}
                                defaultInputValue={HouseholdTypes.Income}
